...
public class OutpatientPrescriptionsActivity extends BaseActivity {
    ...
    private void initData() {
        ...
        String url = "http://192.168.1.252:9401/AppointMentServer/api/medicalRecords-prescribedata/patient-"+Constants.getPatientId(this)+"?token=" + share.getPres("token");
        StringRequest request = new StringRequest(url, new Response.Listener<String>() {
            ...
            public void onErrorResponse(VolleyError error) {
                ToastUtil.ToastShow(OutpatientPrescriptionsActivity.this, "网络错误", true);
                pb.dismiss();
            }
        });
        queue.add(request);
