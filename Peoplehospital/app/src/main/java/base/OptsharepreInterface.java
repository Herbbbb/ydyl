...
public class OptsharepreInterface {
    ...
    public void putPres(String optName, String values) {
        ...
        } else if (optName.equals("isFirstSavaXzqh")) {
            editor.putString("isFirstSavaXzqh", values);// 行政区划状态(0:未加载	1:已加载)
    ...
    public String getPres(String optName) {
        ...
        } else if (optName.equals("isFirstSavaXzqh")) {// 行政区划状态
            values = settings.getString("isFirstSavaXzqh", "0");
